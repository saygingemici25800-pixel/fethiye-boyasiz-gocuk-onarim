...
export function CarIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M5 17h14M5 17l1.5-5h11L19 17M5 17v3M19 17v3M7 12V8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v4" />
...
export function TwitterIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M22 5.8a8.5 8.5 0 0 1-2.36.65 4.13 4.13 0 0 0 1.81-2.27 8.21 8.21 0 0 1-2.61 1 4.1 4.1 0 0 0-7.1 3.74A11.65 11.65 0 0 1 3.39 4.6 4.1 4.1 0 0 0 4.66 10a4.1 4.1 0 0 1-1.86-.51v.05a4.1 4.1 0 0 0 3.29 4 4.1 4.1 0 0 1-1.85.07 4.11 4.11 0 0 0 3.83 2.85A8.22 8.22 0 0 1 2 18.07a11.61 11.61 0 0 0 6.29 1.84c7.55 0 11.68-6.25 11.68-11.67v-.53A8.32 8.32 0 0 0 22 5.8z" />
    </svg>
  );
}
